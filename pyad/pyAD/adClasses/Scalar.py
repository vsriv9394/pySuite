...
def  exp(x): return np.exp(x)  if isinstance(x,Scalar) else x.__exp__()
def  log(x): return np.log(x)  if isinstance(x,Scalar) else x.__log__()
def  sin(x): return np.sin(x)  if isinstance(x,Scalar) else x.__sin__()
def  cos(x): return np.cos(x)  if isinstance(x,Scalar) else x.__cos__()
def  tan(x): return np.tan(x)  if isinstance(x,Scalar) else x.__tan__()
def fabs(x): return abs(x)     if isinstance(x,Scalar) else x.__fabs__()
def sqrt(x): return x**0.5     if isinstance(x,Scalar) else x.__sqrt__()
def sinh(x): return np.sinh(x) if isinstance(x,Scalar) else x.__sinh__()
def cosh(x): return np.cosh(x) if isinstance(x,Scalar) else x.__cosh__()
def tanh(x): return np.tanh(x) if isinstance(x,Scalar) else x.__tanh__()